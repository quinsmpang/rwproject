...
//#ifdef _DEBUG
		...
		//printf( "%.4d/%.2d/%.2d %.2d:%.2d:%.2d %d", newtime->tm_year+1900, newtime->tm_mon+1, newtime->tm_mday, newtime->tm_hour,newtime->tm_min, newtime->tm_sec, newtime->tm_wday );
//#endif
