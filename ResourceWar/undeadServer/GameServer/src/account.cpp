...
int account_in( int actor_index, char type )
{
	...
	//user_fcm( actor_index, g_actors[actor_index].actorid, 0, ClientInfo.username, g_actors[actor_index].name );
...
int account_out( int actor_index, char type )
{
	...
	//user_fcm( actor_index, g_actors[actor_index].actorid, 1, ClientInfo.username, g_actors[actor_index].name );
